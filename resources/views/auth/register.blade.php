    ...
    <div class="col-md-6 col-sm-6 create-new-account">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control unicase-form-control text-input" id="name" name="name" value="">
                @error('name')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control unicase-form-control text-input" id="phone" name="phone" value="">
                @error('phone')
                    <span class="invalid-feedback" role="alert"><b>{{ $message }}</b></span>
                @enderror
            </div>
