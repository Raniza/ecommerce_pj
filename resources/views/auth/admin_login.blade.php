...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('backend/css/skin_color.cs') }}s">	
                                ...
                                <form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" id="name" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Name" name="name" :value="old('name')" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group mb-3">
